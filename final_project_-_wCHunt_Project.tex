...
\section{TODO complete sign eval for
...
1: \[\frac{k_1(e^{-k_1 t}k_1^2-e^{-k_2 t}k_2^2)R}{-k_1+k_2}\] Note that
\(t_0 = \frac{ln k_1 - ln k_2}{k_1 - k_2}\)

\section{TODO complete sign
information}\label{todo-complete-sign-information}

Therefore: \(a''(t) < 0\) for all \(t < 2t_0\);
...
\section{TODO complete sign test}\label{todo-complete-sign-test-2}
