...
\section{TODO Complete Exercise}\label{todo-complete-exercise}
...
graphs of r, a, d, and f. You should not hvae to compute any points
...
Assuming that we are looking for the feed type that stays in the sheeps
