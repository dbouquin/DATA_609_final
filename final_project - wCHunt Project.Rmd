...
Using the chain rule we indentify that:
$$e^{-k1 \frac{\log{(\frac{k1}{k2})}}{(k1 - k2)}}=\frac{k_1}{k_2}^{-\frac{k_1}{k_1 - k_2}}$$
Therefore with subsitution and applying the chain rule the maximum value of $a(t)$ is : 
...
Again, as we saw perviously $e^{-\infty}$ = 0 so our solution : $\lim_{t\to\infty}a(t) =0$
